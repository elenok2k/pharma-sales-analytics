...
print("="*60)
print("ФАРМ-АНАЛИТИКА: ЗАГРУЗКА И ОБРАБОТКА ДАННЫХ")
print("="*60)
...
print(f"✅ Всего продано: {df['amount'].sum():,.0f} упаковок")
...
print("\n" + "="*60)
print("ПРОГНОЗ ПО ДИНАМИКЕ КВАРТАЛОВ 2025")
print("="*60)
...
print("\n" + "="*60)
print("СОЗДАНИЕ ДАШБОРДА С KPI-ТЕКСТОМ")
print("="*60)
